...
// Define the `bookscatApp` module
var bookscatApp = angular.module('bookscatApp', []);

// Define the `BooksListController` controller on the `bookscatApp` module
bookscatApp.controller('BooksListController', function BooksListController($scope) {
  $scope.books = [
    {
      "id":1,
      "author":"Emmie Thiel",
  ...
  $scope.imageUrl = '../assets/default_book.svg';
});
